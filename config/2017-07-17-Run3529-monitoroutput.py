...
mmfes[120].SM = {0: [14, 16, 40],
                 ...
                 5: [],
                 6: [1, 38, 40],
                 7: [1, 12, 21, 25, 26, 29, 30, 34, 62, 63, 64]}
...
mmfes[118].mon = {0:44, 1:9, 3:20, 7:53}
mmfes[111].mon = {0:17}
mmfes[120].mon = {0:41, 1:15, 2:38, 6:41, 7:33}
mmfes[119].mon = {1:17, 3:53, 6:35, 7:38}
mmfes[106].mon = {1:20}
mmfes[107].mon = {6:62}
mmfes[101].mon = {0:1, 6:58, 5:9, 7:1, 3:10}
mmfes[105].mon = {}
