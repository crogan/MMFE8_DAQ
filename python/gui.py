...
class GUI:
    ...
    def set_hardcode(self, mmfeID, vmmID):
        ...
        hardcodes = [(105, 0, 320, [1, 3, 17, 29, 43]),
                     ...
                     (105, 2, 240, [2]),
                     (105, 3, 260, []),
                     (105, 4, 220, [1, 2, 3, 4, 10, 13, 20, 34, 35]),
                     (105, 5, 240, [1, 18]),
                     ...
                     (107, 6, 420, [1, 6, 9, 12, 16, 19, 23, 29, 32, 36, 39, 42, 49, 56, 59]),
                     (107, 7, 460, [5, 12, 19, 28, 35, 52, 62]),
                     (111, 0, 600, [2, 3, 7, 10, 26, 27, 36, 42, 48, 62]),
                     (111, 1, 600, [1, 4, 5, 8, 11, 12, 18, 21, 31, 34, 36, 41, 48, 51]),
                     (111, 2, 520, [7, 10, 17, 30, 34, 38, 51, 54, 61, 64]),
                     (111, 3, 500, [2, 3, 5, 6, 33, 37]),
                     (111, 4, 560, [1, 2, 3, 4, 7, 10, 23, 46, 50, 53]),
                     (111, 5, 480, [12, 22, 32, 36, 56, 60, 63]),
                     (111, 6, 520, [53]),
                     (111, 7, 460, [1, 2, 19, 26, 29, 36, 39, 46, 52, 56]),
                     (116, 0, 480, [1, 2, 26, 28]),
                     (116, 1, 500, [2, 51]),
                     ...
                     (117, 6, 380, [2, 47]),
                     (117, 7, 400, [1, 2, 3, 30, 36, 43, 63]),
                     (118, 0, 340, [1]),
                     (118, 1, 320, []),
                     (118, 2, 300, [1, 6, 31, 33]),
                     (118, 3, 340, [6, 22, 43, 45, 54]),
                     (118, 4, 360, []),
                     (118, 5, 300, []),
                     (118, 6, 300, [1, 3, 4]),
                     (118, 7, 320, [3, 63]),
